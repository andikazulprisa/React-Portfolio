    ...
    <>
      ...
      <div className="about mt-32 py-10" id="about">
        ...
        <div className="tools mt-32">
          ...
          <p
            className="text-base/loose xl:w-2/5 lg:w-2/4 md:w-2/3 w-full sm:w-3/4 opacity-50"
            data-aos="fade-up"
            data-aos-duration="1000"
            data-aos-delay="300"
          >
          ...
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            {listTools.map((tool) => (
              <div
                className="flex items-center gap-2 p-3 border border-zinc-600 rounded-md hover:bg-zinc-800 group key={tool.id}>"
                data-aos="fade-up"
                data-aos-duration="1000"
